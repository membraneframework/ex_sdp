    ...
    test "parses fmtp with sprop-parameter-sets parameters" do
      ...
      expected = %FMTP{
        ...
        sprop_parameter_sets: %{
          sps:
            <<0, 0, 0, 1, 103, 100, 0, 31, 173, 132, 1, 12, 32, 8, 97, 0, 67, 8, 2, 24, 64, 16,
              194, 0, 132, 59, 80, 40, 2, 221, 55, 1, 1, 1, 64, 0, 0, 250, 0, 0, 58, 152, 33>>,
          pps: <<0, 0, 0, 1, 104, 238, 49, 178, 27>>
        }
      }
  ...
  describe "FMTP serializer" do
    ...
    test "serializes FMTP with sprop-parameter-sets" do
      ...
      fmtp = %FMTP{
        ...
        sprop_parameter_sets: %{
          sps:
            <<0, 0, 0, 1, 103, 66, 0, 41, 226, 144, 20, 7, 182, 2, 220, 4, 4, 6, 144, 120, 145,
              21>>,
          pps: <<0, 0, 0, 1, 104, 206, 60, 128>>
        }
      }
